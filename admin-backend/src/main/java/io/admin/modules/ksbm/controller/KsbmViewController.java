...
public class KsbmViewController {
    @Autowired
    private KsbmViewService ksbmViewService;
    ...
    public R list(@RequestParam Map<String, Object> params){
        PageUtils page = ksbmViewService.queryPage(params);
    ...
    public R info(@PathVariable("id") Long id){
			KsbmViewEntity ksbmView = ksbmViewService.selectById(id);

        return R.ok().put("ksbmView", ksbmView);
    }
