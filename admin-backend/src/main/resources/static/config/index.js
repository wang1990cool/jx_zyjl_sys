...
;(function () {
  ...
  // api接口请求地址
//  window.SITE_CONFIG['baseUrl'] = 'http://172.17.1.48:8080/zyjn';
  window.SITE_CONFIG['baseUrl'] = 'http://172.17.1.48:80/zyjn';

  // cdn地址 = 域名 + 版本号
  window.SITE_CONFIG['domain']  = './'; // 域名
  window.SITE_CONFIG['version'] = '1904251619';   // 版本号(年月日时分)
