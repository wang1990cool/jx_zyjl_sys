...
-->
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button v-if="isAuth('zsgl:bjsh:audit')" type="text" size="small" @click="addOrUpdateHandle(scope.row.id)">审核</el-button>
<!--
...
//          key: ''
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/zsgl/bjsh/list'),
          method: 'get',
...
/*      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/zsgl/bjsh/delete'),
            method: 'post',
