...
-->
      ...
      <el-form-item label="审核意见" prop="shbm">
        <el-radio v-model="dataForm.shbm" label="6">通过</el-radio>
        <el-radio v-model="dataForm.shbm" label="5">驳回</el-radio>
      </el-form-item>
<!--
    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/zsgl/zxsh/info/${this.dataForm.id}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/zsgl/zxsh/audit`),
              method: 'post',
